    ...
    return (
        <>
            {apartment && <div className={styles.card}>
                <button onClick={() => {callback(false)}} className={styles.close}>
                    <svg
                ...
                <div className={styles.info}>
                    ...
                    <div className={styles.overviewAbout}>
                        Amazing opportunity to own this 4 Unit Income Producing Property in Harbor City. The property features Four 2 Bedroom and 1 Bathroom units with 1 garage space each and alley access. Couple of the units were recently updated with
                    </div>
