...
const Details: FC<IDetailsProps> = ({apartment, callback}) => (
  <>
    {apartment && (
      <div className={styles.card}>
        ...
        <div className={styles.info}>
          <div className={styles.head}>
            ...
            <h3 className={styles.h3}>{apartment.rooms} bd</h3>
            <h3 className={styles.h3}>{apartment.floor} floor</h3>
            <h3 className={styles.h3}>{apartment.area_total}м²</h3>
          </div>
          <div className={styles.street}>
            ...
            1437 Lomita Blvd APT 223, Harbor City, CA 90710
          </div>
          <div className={styles.buttons}>
            <button className={styles.reqButton}>Request a tour</button>
            <button className={styles.contButton}>Contact agent</button>
          </div>
          <p className={styles.overview}>Overview</p>
          <div className={styles.overviewAbout}>
            Amazing opportunity to own this 4 Unit Income Producing Property in
            Harbor City. The property features Four 2 Bedroom and 1 Bathroom
            units with 1 garage space each and alley access. Couple of the units
            were recently updated with
          </div>
          <p className={styles.overview}>Facts and features</p>
          <div className={styles.additional}>
            <div className={styles.additionalName}>
              ...
              <div className={styles.flex}>
                <h3 className={styles.none}>Kitchen Area: </h3>
                <h3>{apartment.area_kitchen}м²</h3>
              </div>
            </div>
            <div className={styles.additionalName}>
              <svg
              ...
              <div className={styles.flex}>
                <h3 className={styles.none}>Living Area: </h3>
                <h3>{apartment.area_live}м²</h3>
              </div>
            </div>
            <div className={styles.additionalName}>
              <svg
              ...
              <div className={styles.flex}>
                <h3 className={styles.none}>Position on floor: </h3>
                <h3>{apartment.pos_on_floor}</h3>
              </div>
            </div>
          </div>
        </div>
