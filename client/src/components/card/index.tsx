                ...
                <div className={styles.info}>
                    ...
                    <div className={styles.about}>
                        <div className={styles.aboutName}>
                            ...
                            St. "street name", "apartment number"
                        </div>
                        <div className={styles.aboutName}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <div className={styles.description}>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam quis massa at elit tempus suscipit. Phasellus id est fermentum lorem accumsan fermentum a in enim. Cras volutpat, sem et eleifend molestie, purus est hendrerit mi, a placerat enim nisl rutrum nisl. Vestibulum pretium nisi a justo posuere, sit amet hendrerit metus sollicitudin. Suspendisse tempus accumsan maximus. Pellentesque nec dui ultricies, posuere felis ut, faucibus risus. Vestibulum gravida blandit sem vitae hendrerit. Nullam eget faucibus velit. Nullam et tristique diam, a elementum nulla. Vivamus rhoncus aliquam ante. Vestibulum tincidunt ante vitae ante vulputate, mollis ultrices risus malesuada.
                        </div>
                    </div>
                </div>
            </div>
